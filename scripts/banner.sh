...
# A prompt generator using Heydon Pickering's Inclusive Design Checklist
# Forked from: https://github.com/Heydon/inclusive-design-checklist
# Dependencies: https://github.com/charmbracelet/gum

# check for dependencies
if ! $(command -v lolcat >/dev/null 2>&1); then
  echo "please install lolcat to use this script:"
  echo "brew install lolcat"
  exit
fi

INCLUSIVE_DESIGN_CHECKLIST=(
  ...
  "Provide focus traps to dialogs and make other elements non-selectable"
  ...
  "Do not make users perform actions to reveal content unless completely necessary"
...
MAX="${#INCLUSIVE_DESIGN_CHECKLIST[@]}"
RANDOM_INDEX="$((1 + $RANDOM % $MAX))"
echo "$INCLUSIVE_DESIGN_CHECKLIST[$RANDOM_INDEX]" | lolcat
